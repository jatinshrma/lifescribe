export const PostSkeleton = () => (
	<div className="py-6 ss:p-8 space-y-4 border-t border-darkSecondary group first:border-transparent ss:hover:border-transparent ss:[&:hover+div]:border-transparent">
		...
		<p className="ss:my-6 h-4 bg-gray-200 rounded-full dark:bg-neutral-700 w-3/4"></p>
...
export const ProfileSkeleton = () => (
	<>
		<div className="flex items-center ss:gap-20 gap-6 ss:pt-[5rem] ss:pb-[72px] py-6">
			<div className="rounded-full aspect-square ss:w-[20rem] ss:h-[20rem] w-24 bg-gray-200 dark:bg-neutral-700" />

			<div className="ss:space-y-4 space-y-3 ss:w-80 w-full">
				<p className="w-full ss:h-6 h-4 bg-gray-200 rounded-full dark:bg-neutral-700" />
				...
				<div className="flex gap-4">
					<p className="w-20 ss:h-6 h-4 bg-gray-200 rounded-full dark:bg-neutral-700" />
					<p className="w-20 ss:h-6 h-4 bg-gray-200 rounded-full dark:bg-neutral-700" />
				</div>
			</div>
		</div>
	...
	<>
		...
		<div className="ss:mt-12 ss:mb-8 my-6 flex justify-between">
			<div className="flex gap-4 items-center">
				...
				<div className="flex gap-4">
					<p className="ss:w-40 w-20 h-4 bg-gray-200 rounded-full dark:bg-neutral-700" />
					<p className="ss:w-24 w-12 h-4 bg-gray-200 rounded-full dark:bg-neutral-700" />
				</div>
			</div>

			<div className="flex gap-4 items-center">
				<p className="ss:block hidden w-8 h-8 bg-gray-200 rounded-full dark:bg-neutral-700" />
				<p className="ss:block hidden w-8 h-8 bg-gray-200 rounded-full dark:bg-neutral-700" />
				<p className="w-8 h-8 bg-gray-200 rounded-full dark:bg-neutral-700" />
			</div>
		</div>
